...
import 'package:indimobi/screens/late_start/white_frame_page/white_frame_vm.dart';

class WhiteFramePage extends StatefulWidget {
  const WhiteFramePage({Key? key}) : super(key: key);

  @override
  WhiteFramePageState createState() => WhiteFramePageState();
}

class WhiteFramePageState extends State<WhiteFramePage> {
  WhiteFrameVm vm = Get.put<WhiteFrameVm>(WhiteFrameVm());
